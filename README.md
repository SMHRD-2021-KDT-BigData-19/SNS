...
## 4. 핵심 기능 <br>
이 서비스의 핵심 기능은 수업 내용을 토대로 <strong> DB 연결을 통한 로그인, 게시판 CRUD 구현 </strong>입니다. <br>
사용자는 회원가입을 통해 로그인을 할 수 있으면 수정 및 삭제<br> 
게시판의 등록(CREATE) 읽기(READ) 수정(UPDATE) 삭제(DELETE) 서비스를 이용할 수 있습니다.  

학습했던 jsp와 servlet을 응용하기 위하여
게시판 기능은 jsp로만, 회원기능은 servlet과 jsp를 활용하여 작업하였으며<br>
학습을 목표로 jsp의 여러 기능을 복합해 사용하였습니다.
